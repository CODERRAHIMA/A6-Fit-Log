        ...
        <div className="w-full bg-neutral border border-white/5 rounded-2xl p-4">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0 space-y-1">
                    ...
                    <p className="text-sm text-neutral-content/50 mt-0.5 truncate">
                        {equipment}
                    </p>

                    <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-2 text-xs text-neutral-content/70">
                ...
                <div className="hidden md:flex items-center gap-2 shrink-0">
                    ...
                    <Link href={`/workouts/${workout.id}`}>
                        <button className="btn btn-sm text-sm px-4 rounded-full border-white/15 bg-transparent text-neutral-content hover:bg-white/5 font-medium">
                            View Details
                        </button>
                    </Link>
                    ...
                    <button
                        onClick={() => handleRemoveWorkout(activeTab, id)}
            ...
            <div className="flex md:hidden items-center justify-end gap-2 mt-4 pt-4 border-t border-white/5">
